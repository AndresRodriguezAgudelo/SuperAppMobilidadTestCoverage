...
import 'package:Equirent_Mobility/screens/soat_screen.dart';
...
void main() {
  testWidgets('SOATScreen renders without crashing', (WidgetTester tester) async {
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: MaterialApp(
          home: const Scaffold(body: SOATScreen()),
        ),
      ),
    );
    expect(find.byType(SOATScreen), findsOneWidget);
  });
}
